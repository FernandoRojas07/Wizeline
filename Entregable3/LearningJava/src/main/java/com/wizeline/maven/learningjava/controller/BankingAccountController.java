...
public class BankingAccountController {
    ...
    @PostMapping(path = "/inserta/cuenta")
    public ResponseEntity<ResponseDTO> insertaCuenta(@RequestBody BankAccountDTO bankAccountDTO){
        return bankAccountService.insertaCuenta(bankAccountDTO);
    }
}
