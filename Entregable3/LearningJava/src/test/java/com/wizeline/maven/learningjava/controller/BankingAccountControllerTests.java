...
public class BankingAccountControllerTests {
    ...
    @Mock
    private BankAccountDTO bankAccountDTO, bankAccountERR;
    ...
    void antesPrueba() {
        ...
        bankAccountERR.setUserName("fernando.rojas@elektra.com");
        bankAccountERR.setAccountType(AccountType.NOMINA);
        bankAccountERR.setAccountActive(false);
        bankAccountERR.setAccountBalance(5800.6223565952);
        bankAccountERR.setAccountName("Dumy account Fer");
        bankAccountERR.setAccountNumber(12364);
    }
    ...
    @Test
    @DisplayName("Prueba servicio PUT /editaCuenta/tipo/{tipo} con error")
    public void pruebaSendUserIDError() {
        LOGGER.info("LearningJava - iniciando prueba de la prueba PUT /editaCuenta/tipo/{tipo} con error");
        responseEntity = bankingAccountController.editaCuentas("");
        LOGGER.info("Se obtiene el codigo: " + responseEntity.getStatusCodeValue() + " de la prueba PUT /editaCuenta/tipo/{tipo} con error");
        assertEquals(200, responseEntity.getStatusCodeValue());
    }
    ...
    @Test
    @DisplayName("Prueba servicio POST /inserta/cuenta con error")
    public void pruebaInsertaCuentaError() {
        LOGGER.info("LearningJava - iniciando prueba Insert /inserta/cuenta con error");
        responseEntity = bankingAccountController.insertaCuenta(bankAccountERR);
        LOGGER.info("Se obtiene el codigo: " + responseEntity.getStatusCodeValue() + " de la prueba Insert /inserta/cuenta con error");
        assertEquals(406, responseEntity.getStatusCodeValue());
    }

    @Test
    @DisplayName("Prueba servicio DELETE /deleteAccounts")
    public void pruebaEliminaCuentas() {
        LOGGER.info("LearningJava - iniciando prueba DELETE /deleteAccounts");
        responseEntity = bankingAccountController.deleteAccounts(bankAccountDTO);
        LOGGER.info("Se obtiene el codigo: " + responseEntity.getStatusCodeValue() + " de la prueba DELETE /deleteAccounts");
        assertEquals(200, responseEntity.getStatusCodeValue());
    }

    @Test
    @DisplayName("Prueba servicio DELETE /deleteAccounts con error")
    public void pruebaEliminaCuentasError() {
        LOGGER.info("LearningJava - iniciando prueba DELETE /deleteAccounts");
        responseEntity = bankingAccountController.deleteAccounts(bankAccountERR);
        LOGGER.info("Se obtiene el codigo: " + responseEntity.getStatusCodeValue() + " de la prueba DELETE /deleteAccounts");
        assertEquals(200, responseEntity.getStatusCodeValue());
    }
}
